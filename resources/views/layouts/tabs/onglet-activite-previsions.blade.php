<form id="id-frm-previsions">
    <table>
    	...
    	<tr>
    		...
    		<td><input id="id-pre{{$tabnum}}-nbPaNouveaux" type="text" class="tab-prevision-{{$tabnum}}" size="3"></td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td><input id="id-pre{{$tabnum}}-nbHres" type="text" class="tab-prevision-{{$tabnum}}" size="3"></td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td><input id="id-pre{{$tabnum}}-pctNuitSemaine" type="text" class="tab-prevision-{{$tabnum}}" size="3"></td>
    	</tr>
    	{{-- total semaine --}}
    	<tr>
    		<td style="direction:rtl;"><label id="id-lbl-pctTotSemaine-pre{{$tabnum}}" for="id-pre{{$tabnum}}-pctTotSemaine"></label></td>
    		<td><input id="id-pre{{$tabnum}}-pctTotSemaine" type="text" class="total" size="3" disabled></td>
    	</tr>
    	<tr>
    		<td>&nbsp;</td>
    		<td>&nbsp;</td>
    	...
    	<tr>
    		...
    		<td><input id="id-pre{{$tabnum}}-pctNuitWeekend" type="text" class="tab-prevision-{{$tabnum}}" size="3"></td>
    	</tr>
    	{{-- total weekend --}}
    	<tr>
    		<td style="direction:rtl;"><label id="id-lbl-pcTotWeekend-pre{{$tabnum}}" for="id-pre{{$tabnum}}-pcTotWeekend">total</label></td>
    		<td><input id="id-pre{{$tabnum}}-pcTotWeekend" type="text" class="total" size="3" disabled></td>
    	</tr>
    	<tr>
    		<td>&nbsp;</td>
    		<td>&nbsp;</td>
    	...
    	<tr>
    		<td style="direction:rtl;"><label id="id-lbl-pcTotCumul-pre{{$tabnum}}" for="id-pre{{$tabnum}}-pcTotCumul">total</label></td>
    		<td><input id="id-pre{{$tabnum}}-pcTotCumul" type="text" class="total" size="3" disabled></td>
    	</tr>
    	<tr>
    		<td>&nbsp;</td>
    		<td>&nbsp;</td>
